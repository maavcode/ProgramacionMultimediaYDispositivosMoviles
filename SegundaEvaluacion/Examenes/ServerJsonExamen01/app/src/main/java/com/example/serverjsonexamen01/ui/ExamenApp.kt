package com.example.serverjsonexamen01.ui
...
import com.example.serverjsonexamen01.ui.pantallas.PantallaInicio
import com.example.serverjsonexamen01.ui.viewmodel.ExamenViewModel
...
fun ExamenApp(
    ...
    val examenViewModel: ExamenViewModel = viewModel(factory = ExamenViewModel.Factory)
    Scaffold(
        topBar = {
            AppTopBar(
        ...
        NavHost(
            ...
            composable (route = Pantallas.PantallaInicio.name) {
                PantallaInicio(
                    estado = examenViewModel.examenUIState
                )
            }
