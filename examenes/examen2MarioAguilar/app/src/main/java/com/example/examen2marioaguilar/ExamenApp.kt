package com.example.examen2marioaguilar
...
import com.example.examen2marioaguilar.ui.pantallas.PantallaEstadisticas
import com.example.examen2marioaguilar.ui.pantallas.PantallaPrincipal
import com.example.examen2marioaguilar.ui.pantallas.PantallaSorteo
import com.example.examen2marioaguilar.ui.pantallas.PantallaSorteosJugados
...
enum class Pantallas(@StringRes val titulo: Int){
    ...
    PantallaSorteo (titulo = R.string.pantalla_sorteo),
    PantallaSorteosJugados(titulo = R.string.pantalla_sorteos_jugados),
    PantallaEstadisticas(titulo = R.string.pantalla_estadisticas)
    //PantallaEjemplo (titulo = "Pantalla Ejemplo1"),
        ...
        NavHost(
            ...
            composable ( route = Pantallas.PantallaPrincipal.name ){ // IMPORTANTE EL .NAME
                PantallaPrincipal(
                    ...
                    onBotonDecimoPulsado = {
                        navController.navigate(Pantallas.PantallaSorteo.name)

                        examenViewModel.actualizarTipoJuego(TipoJuego.decimo)
                    },
                    onBotonTuDiaPulsado = {
                        navController.navigate(Pantallas.PantallaSorteo.name)

                        examenViewModel.actualizarTipoJuego(TipoJuego.tuDia)
                    },
                    onBotonSorteosJugadosPulsado = {
                        navController.navigate(Pantallas.PantallaSorteosJugados.name)
                    },
                    onBotonEstadisticasPulsado = {
            ...
            composable ( route = Pantallas.PantallaSorteo.name ){

                PantallaSorteo(
                    onBotonAceptarPulsado = {
                        navController.popBackStack(
                            Pantallas.PantallaPrincipal.name,
                            inclusive = false
                        )
                    },
                    onBotonJuegaPulsado = {
            ...
            composable ( route = Pantallas.PantallaSorteosJugados.name ){

                PantallaSorteosJugados(
