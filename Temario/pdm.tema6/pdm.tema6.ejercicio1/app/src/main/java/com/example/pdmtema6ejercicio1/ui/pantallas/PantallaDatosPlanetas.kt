...
fun PantallaDatosPlanetas(
    ...
    when (estado) {
        ...
        is StarwarsUIState.ExitoPlanetas ->
            PantallaExitoPlanetas(
                respuestaPlaneta = estado.data,
...
@Composable
fun PantallaExitoPlanetas(
    respuestaPlaneta: RespuestaPlaneta,
    modifier: Modifier = Modifier
) {
    LazyColumn(modifier = modifier) {
        items(respuestaPlaneta.resultados) { planeta ->
            Box(
